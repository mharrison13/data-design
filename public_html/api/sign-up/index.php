...
/**
 * api for signing up to Very Bad Etsy
 *
...
try {
	...
	if($method === "POST") {
		...
		$messageSubject = "Thank you for signing up to Very Bad Etsy!";
...
<p>You must confirm your email to begin using your Very Bad Etsy account </p>
...
EOF;
		...
		$swiftMessage->setFrom(["mharrison13.edu" => "Mharrison13"]);
		/**
